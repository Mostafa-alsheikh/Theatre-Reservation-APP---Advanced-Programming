...
//    Color seatColor = new Color(227, 195, 157, 255);
//    Color controlButtonsColor = new Color(164, 181, 196, 255);
...
//        screenPanel.setBackground(new Color(0, 0, 0, 255));
...
//        thirdClassPanel.setBackground(new Color(96, 80, 64, 255));
        ...
        secondClassPanel.setBackground(new Color(134, 113, 90, 255));
        thirdClassPanel.setBackground(new Color(96, 80, 64, 255));
//        screenPanel.setBackground(new Color(48, 25, 52, 255));
//        seatsPanel.setBackground(new Color(48, 25, 52, 255));
//        leftPanel.setBackground(new Color(24, 27, 36, 255));
